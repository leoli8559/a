...
board.WriteI2C(serAddr,0x42,0x2) #Vertical Front Porch
...
board.WriteI2C(desAlias0,0x42,0xfc) #PLL_NUM15_8
board.WriteI2C(desAlias0,0x42,0x31) #PLL_NUM7_0
...
board.WriteI2C(desAlias0,0x41,0x22)
board.WriteI2C(desAlias0,0x42,0x80)
