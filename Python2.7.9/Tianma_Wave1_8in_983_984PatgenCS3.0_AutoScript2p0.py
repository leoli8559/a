...
## Total Horizontal Pixels = 1568
## Total Vertical Lines = 896
## Active Horizontal Pixels = 1350
## Active Vertical Lines = 810
## Horizontal Back Porch = 40
## Vertical Back Porch = 20
## Horizontal Sync = 40
## Vertical Sync = 20
## Horizontal Front Porch = 138
## Vertical Front Porch = 46
...
board.WriteI2C(serAddr,0x42,0x46) #VID H Active
board.WriteI2C(serAddr,0x42,0x5) #VID H Active
board.WriteI2C(serAddr,0x41,0x10)
board.WriteI2C(serAddr,0x42,0x46) #Horizontal Active
board.WriteI2C(serAddr,0x42,0x5) #Horizontal Active
board.WriteI2C(serAddr,0x42,0x28) #Horizontal Back Porch
board.WriteI2C(serAddr,0x42,0x0) #Horizontal Back Porch
board.WriteI2C(serAddr,0x42,0x28) #Horizontal Sync
board.WriteI2C(serAddr,0x42,0x0) #Horizontal Sync
board.WriteI2C(serAddr,0x42,0x20) #Horizontal Total
board.WriteI2C(serAddr,0x42,0x6) #Horizontal Total
...
board.WriteI2C(serAddr,0x42,0x14) #Vertical Sync
board.WriteI2C(serAddr,0x42,0x0) #Vertical Sync
board.WriteI2C(serAddr,0x42,0x2e) #Vertical Front Porch
...
board.WriteI2C(serAddr,0x42,0xfc) #M value
board.WriteI2C(serAddr,0x42,0xf) #M value
...
board.WriteI2C(serAddr,0x42,0x59) #Set Link layer vp bpp according to VP Bit per pixel
...
board.WriteI2C(desAlias0,0xb2,0x4c) #Program M value lower byte
board.WriteI2C(desAlias0,0xb3,0x49) #Program M value middle byte
...
board.WriteI2C(desAlias0,0x42,0x28) #HSW lower byte
...
board.WriteI2C(desAlias0,0x4a,0x1)
board.WriteI2C(desAlias0,0x4b,0xf6)
board.WriteI2C(desAlias0,0x4c,0x27)
board.WriteI2C(desAlias0,0x4d,0x0)
board.WriteI2C(desAlias0,0x4e,0x0)
board.WriteI2C(desAlias0,0x48,0x1)
...
board.WriteI2C(desAlias0,0x4a,0x1)
board.WriteI2C(desAlias0,0x4b,0xf6)
board.WriteI2C(desAlias0,0x4c,0x3)
board.WriteI2C(desAlias0,0x4d,0x0)
board.WriteI2C(desAlias0,0x4e,0x0)
board.WriteI2C(desAlias0,0x48,0x1)
...
board.WriteI2C(desAlias0,0x4a,0x1)
board.WriteI2C(desAlias0,0x4b,0x20)
board.WriteI2C(desAlias0,0x4c,0x6)
board.WriteI2C(desAlias0,0x4d,0x0)
board.WriteI2C(desAlias0,0x4e,0x0)
board.WriteI2C(desAlias0,0x48,0x1)
...
board.WriteI2C(desAlias0,0x4e,0x0)
board.WriteI2C(desAlias0,0x48,0x1)
board.WriteI2C(serAddr,0x71,0x48)
board.WriteI2C(serAddr,0x79,0x48)
