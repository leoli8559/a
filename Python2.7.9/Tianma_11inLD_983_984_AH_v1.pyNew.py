...
# apbData0 = board.ReadI2C(serAddr, 0x4b)
# apbData1 = board.ReadI2C(serAddr, 0x4c)
# apbData2 = board.ReadI2C(serAddr, 0x4d)
# apbData3 = board.ReadI2C(serAddr, 0x4e)
...
#
# board.WriteI2C(serAddr, 0x49,
#                0x54)  # Video Input Reset (should be executed after DP video is available from the source)
# board.WriteI2C(serAddr, 0x4a, 0x0)
# board.WriteI2C(serAddr, 0x4b, 0x1)
# board.WriteI2C(serAddr, 0x4c, 0x0)
# board.WriteI2C(serAddr, 0x4d, 0x0)
...
board.WriteI2C(serAddr, 0x42, 0x56)  # Set Link layer vp bpp according to VP Bit per pixel
...
## *********************************************
board.WriteI2C(desAlias0, 0xe, 0x3)  # Enable Write to P0 and P1
...
board.WriteI2C(desAlias0, 0xb2, 0x3)  # Program M value lower byte
...
board.WriteI2C(desAlias0, 0x4a, 0x1)
board.WriteI2C(desAlias0, 0x4b, 0xd4)
...
board.WriteI2C(desAlias0, 0x41, 0x62)
board.WriteI2C(desAlias0, 0x42, 0x4)  # Release Port 1 DTG
