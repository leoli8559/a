...
/****************************************************************************/
#define MSD_INVALID_PHY             0xFFU
#define MSD_INVALID_PORT            0xFFU
#define MSD_INVALID_PORT_VEC        0xFFFFFFFFU
...
#define MSD_IS_BROADCAST_MAC(mac) (((mac).arEther[0] == 0xFF) && ((mac).arEther[1] == 0xFF) && ((mac).arEther[2] == 0xFF) && ((mac).arEther[3] == 0xFF) && ((mac).arEther[4] == 0xFF) && ((mac).arEther[5] == 0xFF))
