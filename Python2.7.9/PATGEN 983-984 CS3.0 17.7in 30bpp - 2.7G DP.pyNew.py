...
board.WriteI2C(serAddr,0x42,0xd) #VID H Active
board.WriteI2C(serAddr,0x41,0x10)
board.WriteI2C(serAddr,0x42,0x48) #Horizontal Active
board.WriteI2C(serAddr,0x42,0xd) #Horizontal Active
...
board.WriteI2C(serAddr,0x42,0xd) #Horizontal Total
...
board.WriteI2C(serAddr,0x42,0x1) #Vertical Sync
board.WriteI2C(serAddr,0x42,0x0) #Vertical Sync
board.WriteI2C(serAddr,0x42,0xe) #Vertical Front Porch
...
board.WriteI2C(serAddr,0x42,0xbe) #M value
board.WriteI2C(serAddr,0x42,0x35) #M value
...
board.WriteI2C(desAlias0,0x42,0xaf) #DTG detect HS/VS active low
...
board.WriteI2C(desAlias0,0x4b,0x40)
board.WriteI2C(desAlias0,0x4c,0x0)
board.WriteI2C(desAlias0,0x4d,0x3f)
board.WriteI2C(desAlias0,0x4e,0x0)
board.WriteI2C(desAlias0,0x48,0x1)
...
board.WriteI2C(desAlias0,0x4c,0xd)
board.WriteI2C(desAlias0,0x4d,0x0)
board.WriteI2C(desAlias0,0x4e,0x0)
board.WriteI2C(desAlias0,0x48,0x1)
...
board.WriteI2C(serAddr, 0x1D, 0x89)#SET TI983 GPIO6 LOCK interrupt                                                      
board.endI2C()